...
def sort_faces_by_distance(faces):
    ...
    return [face for face, _ in sorted_faces] #sorted from furthest to closest
...
def rotate_all():
    global points
    points = rotateX(rotateY(points)) #could make more efficient by matrix multiplying the rotation matrixes and then matrix multipy with transposing the points array
